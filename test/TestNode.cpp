...
{    
    ...
    try {
        ...
        BOOST_FAIL("Node::setValue failure");
    }
    
    cout << "- Node::getValue test" << endl;
    BOOST_REQUIRE_MESSAGE(node1.getValue()==value,"Node::getValue failure");
    
    cout << "- Node::setStatus test" << endl;
    vector<bool> status;
    ...
    try {
        ...
        BOOST_FAIL("Node::setStatus failure");
    }
